...
//   $sql = "SELECT username FROM users WHERE username = '$username'";
  ...
  $sql = "INSERT INTO `art`.`users`(`name`, `email`,  `phone`, `gender`, `address`, `city`, `state`, `username`, `password`) VALUES ('$name', '$email', '$phone', '$gender', '$address', '$city', '$state', '$username', '$password');";
      $stmt = mysqli_query($con, $sql);
          if($stmt)
          {   
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <ul class="navbar-nav">
    ...
    <div class="container">
        ...
        ?>
        <form action="L&R_Register.php" method="post">
